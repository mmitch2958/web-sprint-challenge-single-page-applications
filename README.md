...
1. How would you explain form validation to someone who has never programmed before?
    Form validation is a way of checking each of the form componetnts to make sure the correct information is being retreived 

1. In 1-2 sentences, define end to end testing.
    Methodoligy used to test weather the flow of an app is performing as designed from end to end. its to identify system depencies to ensure the right information is being passsed through 
## Instructions
